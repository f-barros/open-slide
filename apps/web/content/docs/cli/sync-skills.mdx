...
Copies the latest skill definitions from your installed `@comp-slide/core`
into the workspace under `.agents/skills/`, and refreshes the
`.claude/skills/` symlinks so Claude Code picks them up too.

Run this after upgrading `@comp-slide/core` — that's how you pull in skill
...
.agents/
└── skills/
    └── <name>/        # canonical copy from @comp-slide/core
.claude/
└── skills/
